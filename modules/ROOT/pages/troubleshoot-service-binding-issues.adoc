...
* `$ asmctl adapter binding list`
+
The status of the binding displays as `ErrorInstanceNotReady`. Check the status of the referenced instance by running one of the following commands (depending if you are using api or adapter binding)
