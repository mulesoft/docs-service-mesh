...
== API Spec size exceeds allowed supported size

When provisioning an API with a large specification file (current limit is `550KB`) you might face some issues on the provision operation or even the Service Mesh services.
