...
| name | The unique name that represents the Kubernetes resource name and the Kubernetes Service to bind with the API, for example, `service-binding-anypoint-security`. 
...
| adapter | Specify the name of the adapter of the Kubernetes resource that you provisioned earlier.  | Required | Not applicable
...
--namespace=<namespace name> \
--adapter=<adapter of the Kubernetes resource> \
--api=<API name of the Kubernetes resource> \
--serviceName=<service name>
----
+
[%header%autowidth.spread]
|===
| Parameter Name | Description | Required or Optional | Default Value
| name | The unique name that represents the Kubernetes resource name and the Kubernetes Service to bind with the API, for example, `service-binding-anypoint-security`. | Required | Not applicable
| namespace | The namespace in which your service is deployed. Ensure that you use the same namespace as the adapter you provisioned earlier. | Required | Not applicable
| adapter | Specify the adapter name of the Kubernetes resource that you provisioned earlier.  | Required | Not applicable 
| api | Specify the API name of the Kubernetes resource you want to associate with this adapter. | Required | Not applicable
