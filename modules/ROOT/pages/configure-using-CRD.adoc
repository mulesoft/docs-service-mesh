= Configure Anypoint Service Mesh using the CRD
...
The following diagram explains the flow for configuring Anypoint Service Mesh using the CRD.

image::configure-service-mesh-CRD-flowchart-new.png[]
