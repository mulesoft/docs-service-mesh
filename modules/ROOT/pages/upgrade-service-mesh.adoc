= Upgrade to Anypoint Service Mesh 1.1
...
Anypoint Service Mesh v1.1 includes new features and architecture enhancements, such as the authorization mechanism aspect of the mixer is now implemented by leveraging Anypoint Service Mesh Envoy filters. Note that the architectural changes in the upgrade require some downtime.
...
* Istio 1.6.0 or later for both control plane and data plane


== Steps

To upgrade to Anypoint Service Mesh v1.1:
