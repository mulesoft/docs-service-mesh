...
Anypoint Service Mesh v1.1 includes new features and architecture enhancements, such as bypassing Istio Mixer when sending requests from clients to Anypoint Platform. Note that architectural changes in the upgrade require some downtime.
