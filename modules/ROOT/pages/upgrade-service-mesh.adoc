...
Anypoint Service Mesh v1.2 includes new features and architecture enhancements, such as leveraging Anypoint Service Mesh Envoy filters to implement the mixer authorization mechanism. Note that implementing these changes requires some downtime.
