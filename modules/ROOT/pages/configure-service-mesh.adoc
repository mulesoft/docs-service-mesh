...
| namespace | The namespace in which you want to create the adapter, for example, “mulesoft-apps”. For the Beta exercise, use “marketing” for this parameter | Required | Namespace
| size | The size of the adapter based on the number of CPUs and memory to use | Required | Medium
| clientId | The client ID of the application | Required | 100
| clientSecret | The client secret of the application | Required | 100
| platformUri | The URL of the host where Anypoint Platform is installed | Required | https://anypoint.mulesoft.com
|===
+
