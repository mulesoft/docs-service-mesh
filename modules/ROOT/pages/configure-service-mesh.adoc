...
. <<beta-service-mesh::provision-adapter-configure-service-mesh.adoc,Provision Anypoint Service Mesh Adapter>>
. <<create-an-api-configure-service-mesh.adoc,Create an API>>
. <<bind-api-configure-service-mesh.adoc,Bind your service>>
