...
. <<provision-adapter-configure-service-mesh#provision_the_adapter,Provision Anypoint Service Mesh Adapter>>
. xref::create-an-api-configure-service-mesh.adoc[Create an API]
. <<bind-api-configure-service-mesh#bind_the_service,Bind your service>>
