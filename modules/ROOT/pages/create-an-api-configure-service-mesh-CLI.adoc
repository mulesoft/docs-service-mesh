...
+
If you want to upload a REST API or OAS asset type, you must use a .json or .yaml file. Alternatively, if you want to upload a SOAP API or WSDL asset type, use a .wsdl or .xml file.
