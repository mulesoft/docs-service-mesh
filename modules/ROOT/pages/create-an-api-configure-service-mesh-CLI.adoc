...
+
When creating file-required APIs (REST, SOAP), the specification file needs to be available in your file system for the CLI to upload it. Due to Kubernetes limitations, specification files used in this provisioning approach should not exceed 550KB in size.
* <<create-api-AP, Create an API using Anypoint Platform>>
+
You can always create APIs manually using Anypoint Platform. Use this approach when dealing with large API specifications (`> 550KB`).
+
