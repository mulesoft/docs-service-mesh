...
IMPORTANT: Since October 29th of 2022, the user credentials option for API autocreate feature is no longer supported. Migration to the Connected Apps approach is required. For more information, read the section below and the xref:obtain-connected-apps-credentials.adoc[Obtain Connected Apps credentials page].
