...
* <<create-api-ASM-CLI-ConnAps, Create an API using Anypoint Service Mesh Autocreate with client credentials>>
+
...
Use the procedure in this section to automatically create an API using Anypoint Service Mesh using your Connected Apps client credentials. Before you create the API, you must complete the task prerequisite.
...
To create an API using Anypoint Service Mesh with client credentials, perform the following steps:
