...
+
Anypoint Service Mesh enables you to automatically create an API in Anypoint Platform using the xref:access-management::connected-apps-overview.adoc[Connected Apps] credentials. You do not have to manually log in to Anypoint Platform.
+
