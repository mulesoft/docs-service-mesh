...
+
You can create APIs using Anypoint Platform. Use this approach for API specification files that are greater than 550 KBs.
+
...
* <<create-api-ASM-CLI, Create an API using Anypoint Service Mesh Autocreate with user credentials>>
+
Anypoint Service Mesh enables you to automatically create an API in Anypoint Platform using username and password. You do not have to manually log in to Anypoint Platform. Use this option if your users are managed by Anypoint Platform. 
+
...
* <<create-api-ASM-CLI-ConnAps, Create an API using Anypoint Service Mesh Autocreate with Connected Apps>>
+
Anypoint Service Mesh enables you to automatically create an HTTP API in Anypoint Platform using the xref:access-management::connected-apps-overview.adoc[Connected Apps] credentials. You do not have to manually log in to Anypoint Platform.
+
Use this option if your users are managed by an external identity provider (IdP).
...
To create an API using Anypoint Service Mesh with user credentials, perform the following steps:
...
== Create an API Using Anypoint Service Mesh With Connected Apps

Use the procedure in this section to automatically create an API using Anypoint Service Mesh with your Connected App credentials. Before you create the API, you must complete the task prerequisite.
...
To create an API using Anypoint Service Mesh with Connected Apps, perform the following steps:
...
| `specTags` | Tags to add to the asset on Exchange. |  Optional | Not applicable
| `instanceTags` | Tags to add to the API instance on API Manager. |  Optional | Not applicable
| `clientId` | The client ID of the Anypoint Platform, using which to create the API. | Required | Not applicable
| `clientSecret` | The client secret of the Anypoint Platform, using which to create the API. | Required | Not applicable
|===
+
. Verify the API status using the following command:
`asmctl api list`
