...
| `version` | The version of the asset on Exchange. *Needs to be semver* what is this chirag? | Required | Not applicable
...
| `specTags` | Tags to be added to the asset on Exchange. |  Optional | Not applicable
| `instanceTags` | Tags to be added to the API instance on API Manager. |  Optional | Not applicable
