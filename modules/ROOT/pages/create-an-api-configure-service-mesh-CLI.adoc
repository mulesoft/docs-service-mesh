...
----
asmctl api create  
--name=<API Kubernetes resource name> \
...
| `name` | The name of the API Kubernetes resource that you want to provision, for example, `orders-api`. | Required | Not applicable
