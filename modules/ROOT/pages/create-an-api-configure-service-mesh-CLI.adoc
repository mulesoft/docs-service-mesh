...
+
When creating file-required APIs (REST, SOAP), the specification file needs to be available in your file system for the CLI to upload it. Specification files used in this provisioning approach should not exceed 550KB in size.
