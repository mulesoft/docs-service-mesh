...
. In the left navigation pane, ensure that you are viewing the menu for your main organization for the *Connected Apps* option to appear.
. Optionally, if you need to change to the main organization, go to the top-right corner of the page and click the Business Groups icon.
