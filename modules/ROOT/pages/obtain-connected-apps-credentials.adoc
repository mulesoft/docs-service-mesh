...
. In the left navigation pane, ensure that you are viewing the menu for your root organization for the *Connected Apps* option to appear.
. Optionally, if you need to change to the root organization, go to the top-right corner of the page and click the Business Groups icon.
