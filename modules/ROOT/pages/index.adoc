...
[IMPORTANT] 
====
Anypoint Service Mesh is scheduled for EOL. To integrate your micro services with Anypoint Platform, use xref:gateway::index.adoc[Flex Gateway]. 


Integrating Flex Gateway enables you to leverage the xref:gateway::policies-included-directory.adoc[Flex Gateway included policies], xref:pdk::policies-pdk-overview.adoc[Flex Gateway Policy Development Kit (PDK)], Anypoint Platform, Flex Gateway monitoring and logging, and much more.

To learn how to integrate Flex Gateway with Istio Service Mesh, see xref:gateway::flex-gateway-istio.adoc[].
...
Anypoint Service Mesh is an independent architecture layer encapsulated in a Kubernetes or a Red Hat OpenShift cluster. In the Anypoint Service Mesh architecture, instead of the services directly communicating with one another, a sidecar proxy is used to perform the same job.  
...
* link:https://docs.mulesoft.com/release-notes/service-mesh/anypoint-service-mesh[Anypoint Service Mesh Release Notes]
