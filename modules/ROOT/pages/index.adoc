...
:page-aliases: service-mesh-overview-and-landing-page.adoc
...
With Anypoint Service Mesh, you can connect your non-Mule applications, data, and devices through APIs in an application network. You can manage, govern, and secure your application network using Anypoint Platform.

When your microservices can exist outside of the MuleSoft ecosystem, built using different languages and deployed to different environments. Anypoint Service Mesh enables you to extend your application network to any type of microservice. 
