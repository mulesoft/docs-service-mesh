...
** Install <<install_Istio,Istio>> (versions 1.7.x through 1.11.x)
* If installing Anypoint Service Mesh 1.2.1 or above:
** Install Kubernetes (versions 1.22 through 1.24)
** Install <<install_Istio,Istio>> (versions 1.11.x through 1.14.x)
* Not install https://svc-cat.io/[Service Catalog^] in the target cluster
+
