...
You require a Anypoint Service Mesh license to perform the installation in your production environment. Ensure that the license you specify is in a digested format. If you do not have a license, contact your MuleSoft representative.
