...
Anypoint Service Mesh supports Istio 1.5.x versions `1.5.0` through `1.5.2`. To install and configure Istio 1.5.x for Anypoint Service Mesh:
...
Anypoint Service Mesh supports Istio 1.4.x versions `1.4.0` through `1.4.8`. To install and configure Istio 1.4.x for Anypoint Service Mesh:
