...
* Kubernetes api-server network connectivity to the webhook pod and Kubernetes cluster compliance with other xref:https://istio.io/docs/ops/configuration/mesh/webhook/#verify-dynamic-admission-webhook-prerequisites[Istio network prerequisites.] 
