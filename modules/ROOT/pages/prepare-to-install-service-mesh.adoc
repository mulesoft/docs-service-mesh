...
* <<install_Istio,Istio>> (currently supported versions include 1.7.x, 1.8.x, 1.9.x, and 1.10.x)
* https://svc-cat.io/[Service Catalog^] must not be installed in the target cluster
