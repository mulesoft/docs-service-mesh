...
* Istall one of the following environments on which to run Kubernetes:
** Google Kubernetes Engine (GKE)
** Amazon EKS
** Azure Kubernetes Service (AKS)
** Red Hat OpenShift
* Install Kubernetes (versions 1.12 through 1.20) or Red Hat OpenShift (version 4.x)
* Install <<install_Istio,Istio>> (currently supported versions include 1.7.x, 1.8.x, 1.9.x, and 1.10.x)
