...
Anypoint Service Mesh supports Istio versions 1.7.x and 1.8.x. You can install either of these Istio versions in your environment within your Kubernetes or OpenShift cluster.
