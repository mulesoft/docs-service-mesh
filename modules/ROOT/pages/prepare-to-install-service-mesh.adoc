...
+
Provisioning your adapter using organization-level credentials enables you to manage all the APIs in every environment of your organization.

** With environment credentials
+
Provisioning your adapter using environment-level credentials enables you to manage APIs of only that specific environment of your organization.
