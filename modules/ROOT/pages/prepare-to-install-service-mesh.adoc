...
* From API Manager > Environmetn Information, obtain the client ID and client secret credentials to provision the adapter. You can provision the adapter with:
+
