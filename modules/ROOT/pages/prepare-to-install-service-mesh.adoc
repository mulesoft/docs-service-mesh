...
You might need to allow a list of hostnames and ports of external resources in your network. This helps you to enable Anypoint Service Mesh to communicate with the MuleSoft-managed online Anypoint Platform APIs and services:
...
Anypoint Service Mesh supports Istio versions 1.6.0 through 1.6.8 and 1.7.0. You can install any of these Istio versions in your environment.
