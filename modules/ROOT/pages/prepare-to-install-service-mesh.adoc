...
* https://istio.io/docs/setup[Install Istio] 1.4.4 or 1.4.5 in your cluster with the following configurations: 
. Enable policy control by configuring the flag:
** `--set values.global.disablePolicyChecks=false`
+
For more information, see https://istio.io/docs/tasks/policy-enforcement/enabling-policy/[Policy Enforcement]. For other versions of Istio, contact your Mulesoft representative to get the proper configuration.
