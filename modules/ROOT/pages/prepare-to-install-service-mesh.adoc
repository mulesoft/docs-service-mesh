...
Your Anypoint Service Mesh installation requires at least the following hardware configuration:
...
You require an Anypoint Service Mesh license to perform the installation in your production environment.
