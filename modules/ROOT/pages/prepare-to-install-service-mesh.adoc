...
You can install Istio 1.4.x, 1.5.x or 1.6.x in your environment to support Anypoint Service Mesh. However, the Istio configuration for Anypoint Service Mesh differs based on the Istio version that you installed.

=== Install Istio 1.6.x

Anypoint Service Mesh supports Istio versions `1.6.0` through `1.6.6`. To install and configure Istio 1.5.x for Anypoint Service Mesh:
...
Anypoint Service Mesh supports Istio versions `1.5.0` through `1.5.8`. To install and configure Istio 1.5.x for Anypoint Service Mesh:
...
Anypoint Service Mesh supports Istio versions `1.4.0` through `1.4.10`. To install and configure Istio 1.4.x for Anypoint Service Mesh:
