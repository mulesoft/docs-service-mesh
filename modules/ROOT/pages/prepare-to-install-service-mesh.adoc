...
* Kubernetes api-server network connectivity to the webhook pod and Kubernetes cluster compliance with other https://istio.io/docs/ops/configuration/mesh/webhook/[Istio network prerequisites.] 
