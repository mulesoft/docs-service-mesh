...
Service Mesh has been tested in Istio versions from `1.5.0` to `1.5.2`. To install and configure Istio 1.5.x for Anypoint Service Mesh:
...
Service Mesh has been tested in Istio versions from `1.4.0` to `1.4.8`. To install and configure Istio 1.4.x for Anypoint Service Mesh:
