...
|*ALL*|*get.helm.sh* | 443| Required to retrieve and install Helm on the computer from where the user is installing the product
|*ALL*|*storage.googleapis.com* | 443| Required to retrieve and install kubectl on the computer from where the user is installing the product
|===
