...
* Have installed one of the following environments on which to run Kubernetes:
** Google Kubernetes Engine (GKE)
** Amazon EKS
** Azure Kubernetes Service (AKS)
** Red Hat OpenShift
* Have installed Kubernetes (versions 1.12 through 1.20) or Red Hat OpenShift (version 4.x)
* Have installedd <<install_Istio,Istio>> (currently supported versions include 1.7.x, 1.8.x, 1.9.x, and 1.10.x)
* Not have installed https://svc-cat.io/[Service Catalog^] in the target cluster
...
Anypoint Service Mesh supports specific Istio <<supported_versions,versions>>. You can install any of these Istio versions in your environment within your Kubernetes or OpenShift cluster.
