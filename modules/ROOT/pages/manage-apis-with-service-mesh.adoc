...
After you configure Service Mesh, you are now ready to manage your non-Mule microservices from API Manager. You can apply policies to ensure various levels of security for your microservices. 
