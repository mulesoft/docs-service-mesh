...
After you configure Service Mesh, you are now ready to manage your Mule and non-Mule applications from API Manager. You can apply policies to ensure various levels of security for your microservices. 
...
. Go to *API Manager* and select the specific API instance.
The API instance details are displayed.
