...
*Step 3:* Configure Anypoint Service Mesh--You are not yet ready to start using Anypoint Service Mesh until you provision the Service Mesh adapter and bind the service namespace with the adapter. After you complete these steps, you can start managing your APIs using Service Mesh. 
