...
+
When creating file-required APIs (REST, SOAP), the specification file content needs to be base64 encoded and embedded into the CRD. Specification files used in this provisioning approach should not exceed 550KB in size.
