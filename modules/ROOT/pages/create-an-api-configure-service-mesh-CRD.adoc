...
Ensure that you obtain the environment ID and organization ID. You can find this information from API Manager, go to *API Manager > Environment Information*
