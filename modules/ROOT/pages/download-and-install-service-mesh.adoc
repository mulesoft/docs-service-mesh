...
`curl -Ls http://anypoint.mulesoft.com/servicemesh/xapi/v1/install?version=v1.1.1 > asmctl && chmod +x asmctl`
...
| `mtls` | Enable Mutual TLS (mTLS) authentication in adapter connections: enabled or disabled | Optional | disabled
