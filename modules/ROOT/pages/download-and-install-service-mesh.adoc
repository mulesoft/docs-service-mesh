...
As part of the installation process, the following dependency checks are performed by the Anypoint Service Mesh installer:

- Kubernetes versions is supported.
- Istio is not installed.
- Service Catalog is not installed.
- Service Mesh is not installed.
- User is entitled to use service mesh.
