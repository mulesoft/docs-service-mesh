...
Before you can start managing your services using Service Mesh, you must prepare your namespace by provisioning a Service Mesh adapter. Provisioning prepares the namespace for the Service Mesh configuration. As a best practice, you must create one namespace per adapter.
