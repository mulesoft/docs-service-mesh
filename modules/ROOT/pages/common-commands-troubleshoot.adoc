...
If you have multiple replicas, you can change the index on the _items_ array.
...
+
You can view the information from the `_replace_with_adapter_name_-policies-folder.tar.gz` folder.
