...
When you create the binding, Anypoint Service Mesh takes few seconds to complete the binding procedure and update the status. After the binding is completed, you can view the status using the `list` command. The status values include:
