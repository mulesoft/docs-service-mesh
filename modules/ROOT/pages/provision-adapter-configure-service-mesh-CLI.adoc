...
Before you can start managing your services using Anypoint Service Mesh, you must prepare your namespace by provisioning a Anypoint Service Mesh adapter. Provisioning prepares the namespace for the Anypoint Service Mesh configuration. On every namespace where you want to protect your APIs with Anypoint Service Mesh, you must provision an adapter.
