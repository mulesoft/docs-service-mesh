...
If you created the API in the previous procedure using Anypoint Platform, you use the API ID to bind the service. However, if you used Anypoint Service Mesh to create the API, you must use the API name to bind the service.
