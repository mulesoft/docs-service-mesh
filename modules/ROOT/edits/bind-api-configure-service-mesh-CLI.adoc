...
You can bind an API to a service using the API ID or Anypoint Service Mesh API name, based on your preference:

* <<bind_the_service, Bind an API usinf an API ID>>:  Use this procedure if you want to bind to the API using the API ID. This method is recommended if you created your API using Anypoint Platform.
* <<bind_using_ASM, Bind an API using an API name>>: Use this procedure if you want to bind to the API using the Service Mesh API name. This method is recommended if you created your API using Anypoint Service Mesh.

[[bind_the_service]]
== Bind an API Using API ID (Anypoint Platform)
...
== Bind an API Using API Name (Anypoint Service Mesh)
