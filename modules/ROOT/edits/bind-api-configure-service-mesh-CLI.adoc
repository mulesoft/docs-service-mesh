...
* <<bind_the_service, Bind an API referencing an API ID>>:  Use this procedure if you want to bind to the API using the API ID. This method is recommended if you created your API using Anypoint Platform.
* <<bind_using_ASM, Bind an API created using Anypoint Service Mesh API name>>: Use this procedure if you want to bind to the API using the Service Mesh API name. This method is recommended if you created your API using Anypoint Service Mesh.
